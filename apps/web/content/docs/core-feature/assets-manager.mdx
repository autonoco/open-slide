...
![Autono assets panel showing the app logo](/assets/screenshots/autono-assets.png)
...
![Autono svgl logo search in the Assets panel, showing brand logo results for a search query](/assets/screenshots/autono-svgl.png)
