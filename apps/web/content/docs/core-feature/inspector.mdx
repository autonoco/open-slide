...
![Autono inspector with the property panel docked beside the canvas, editing a selected element's typography and colour](/assets/screenshots/inspector.webp)

The inspector is a dev-only overlay built into the Autono runtime. Toggle
